...
void registeralllibs(environment *env) {
    ...
    registerraymodule(env);
    registerphysmodule(env);
    registervrmodule(env);
    registerrlmodule(env);
    registerllmmodule(env);
    registerasyncmodule(env);
    registerfibermodule(env);
    registerchannelmodule(env);
    registersemmodule(env);
    registerpoolmodule(env);
    registerhttp3module(env);
    registerssemodule(env);
    registergraphqlmodule(env);
    registerciphermodule(env);
    registerjwtmodule(env);
    registeroauthmodule(env);
    registerbigintmodule(env);
    registercomplexmodule(env);
    registerbigdecmodule(env);
    registermatrixmodule(env);
    registerdataframemodule(env);
    registersymmodule(env);
    registerplotmodule(env);
    registerviz3dmodule(env);
    registergpumodule(env);
    registerjitmodule(env);
    registersandboxmodule(env);
    registerstackmodule(env);
    registerpluginmodule(env);
    registervulkanmodule(env);
    registerd3d12module(env);
    registeranimmodule(env);
    registeraudiomodule(env);
    registernetmodule(env);
    registerecsmodule(env);
    registerscenemodule(env);
    registerassetmodule(env);
    registerconsolemodule(env);
    registerwsmodule(env);
    registersessionmodule(env);
    registerfrontendmodule(env);
    registerapimodule(env);
    registerratelimitmodule(env);
    registerxommodule(env);
    registerscimodule(env);
    registerxlearnmodule(env);
    registertorchmodule(env);
    registerfluxmodule(env);
    registervision2module(env);
    registershieldmodule(env);
    registercleanmodule(env);
}
